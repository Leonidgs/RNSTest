...
public class BasePage {
    ...
    //Для работы с выпадающим списком
    public Select select(WebElement elem) {
    ...
    public Object fieldChecker(WebElement element, String expectedValue) {
        attributeToBe(element, "innerText" ,expectedValue);
        System.out.println(element.getText());
        if (element.getText().equalsIgnoreCase(expectedValue)) {
            return this;
        }
        Assert.fail("Ставка " + expectedValue + " не была сконфигурирована ");
        return this;
    }
}
